...
<nav class="nav__cont">
  ...
  <ul class="nav">
    <li class="nav__items3">
     ...
     <a href="/view_sh/manager_car" class="nav_items_text3">차량</a>
     <div class="mon_nav_items">
    ...
    <li class="nav__items3">
     ...
     <li class="nav__items3">
      ...
      <a class="nav_items_text3" onclick="window.open('/view_jh/admin_Stats_MainForm', '_blank', 'width=1400, height=1000, left=250, scrollbars=yes')">통계</a>
      <div class="mon_nav_items">
