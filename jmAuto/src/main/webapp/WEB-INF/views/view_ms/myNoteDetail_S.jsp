...
<body>
	<div class="container">
		...
		<div class="block">
			...
			<!-- 현재 버튼 클릭시 onclick만 실행이되고 위에 <a></a>태그에 있는 로직은 실행되지 않고 있었음.. -->
			
			<button value="note" onclick="window.open('/view_ms/go_noteDabjang_form_S?note_num=${Note.note_num}&note_sd=${Note.note_sd}&sell_num=${Note.sell_num}&note_title=${Note.note_title}', '_blank', 'width=600, height=600, left=260, top=100, scrollbars=yes'); return false;">답장하기</button>
			</a>
			</c:if>
